import {test} from 'node:test';import assert from 'node:assert/strict';import {mkdtempSync,readFileSync,rmSync} from 'node:fs';import {tmpdir} from 'node:os';import {join,resolve,sep} from 'node:path';import {PNG} from 'pngjs';
import {ExperienceStore,visualDescriptor,visualDistance} from '../server/memory/store';import {checkpoint,learn,retryBudget,adapterContext} from '../server/memory/adapter';import type {Circuit} from '../shared/types';import type {ExhibitDecision} from '../shared/exhibit';import type {Encounter} from '../shared/observation';
