...
await page.locator('.apparatus-panel>summary').click();await page.waitForTimeout(800);await page.locator('.apparatus-panel').screenshot({path:'runtime/apparatus-integrated.png'});
await page.setViewportSize({width:390,height:844});await page.locator('.apparatus-panel>summary').click();await page.screenshot({path:'runtime/exhibit-mobile.png',fullPage:true});
